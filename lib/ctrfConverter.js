...
class CtrfConverter {
    ...
    parseTests(report) {
        ...
        suites.forEach(suite => {
            let sortedTests = lodash_1.default.sortBy(suite.tests, ['title']);
    ...
    async convert(options) {
        ...
        const stats = mochawesomeCommon_1.MochawesomeCommon.createStats(Object.values(this.suites).length, tests, failed, pending, skipped, options, pendingPercent, other, Math.ceil(this.duration));
        const mochawesome = {
            stats: stats,
