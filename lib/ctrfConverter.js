...
class CtrfConverter {
    ...
    parseTests(report, totalSuiteTime) {
    ...
    async convert(options) {
        ...
        // this.results.push({
        //     uuid: report.reportId || crypto.randomUUID(),
        //     title: report.results.environment?.reportName || '',
        //     fullFile: '',
        //     file: '',
        //     beforeHooks: [],
        //     afterHooks: [],
        ...
        let duration = report.results.summary.duration
        ...
        const stats = mochawesomeCommon_1.MochawesomeCommon.createStats(Object.values(this.suites).length, tests, failed, pending, skipped, options, pendingPercent, other, Math.ceil(duration));
        const mochawesome = {
            stats: stats,
